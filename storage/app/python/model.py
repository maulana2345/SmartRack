...
try:
    ...
    print("❌ Stock harus angka bulat.", file=sys.stderr)
    sys.exit(1)
...
required_columns = ['kode_rak', 'kapasitas_tersedia', 'jarak']
for col in required_columns:
    if col not in df_rak.columns:
        print(f"❌ Kolom '{col}' tidak ditemukan di data rak.", file=sys.stderr)
        sys.exit(1)
